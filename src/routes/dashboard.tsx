...
export const Route = createFileRoute("/dashboard")({
  head: () => ({
    meta: [
      { title: "Dashboard — Claude Code OS" },
      {
        name: "description",
        content:
        ...
        <header className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <KpiPanel
              ...
              icon={DollarSign}
              value={
                skillsConfigured ? fmtMoney(savedPeriod.dollars) : fmtMoney(0)
              }
              sub={
                skillsConfigured
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
              ...
              <div className="text-[10px] text-muted-foreground tabular-nums">
                {spendView === "subscription" ? (
                  ...
                  <>
                    {fmtMoney(tokenEquivalent, { decimals: 2 })} equivalent · {spendSub}
                  </>
                )}
              </div>
            </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-muted-foreground">
                            {spendSub} · {fmtMoney(dollars, { decimals: 2 })} of {fmtMoney(spendValue, { decimals: 2 })} total
                          </div>
                        </div>
                      </div>
                      <button
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-5 items-center">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          ...
                          <BigStat
                            label="Avg cost / call"
                            value={fmtMoney(avgCost, { decimals: 3 })}
                            accent={`#${m.color}`}
                            icon={DollarSign}
                          />
                          <BigStat
                        ...
                        <div className="grid grid-cols-2 gap-3 pt-3 border-t border-border/60">
                          <div className="flex items-center justify-between text-[11px]">
                            ...
                            <span className="font-mono tabular-nums">{fmtMoney(Number(inRate), { decimals: 2 })}/M tok</span>
                          </div>
                          <div className="flex items-center justify-between text-[11px]">
                            <span className="text-muted-foreground">Output rate</span>
                            <span className="font-mono tabular-nums">{fmtMoney(Number(outRate), { decimals: 2 })}/M tok</span>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  return (
    <>
      <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 mb-3 text-[12px]">
        ...
        <span className="text-foreground font-semibold tabular-nums text-base">
          {fmtMoney(apiEquivalentWithFree)}
        </span>
        <span className="text-muted-foreground/60">·</span>
